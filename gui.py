...
trackframe = LabelFrame(self.root,text="SongTrack",font=("Helvetica",14,"bold"),bg="#1f7a8c",fg="white",bd=5,relief=RAISED)
...
playbtn = Button(buttonframe,text="Play",command=self.playsong,width=10,height=1,font=("Helvetica",12,"bold"),fg="white",bg="#1f7a8c").grid(row=0,column=0,padx=10,pad y=5)
...
playbtn = Button(buttonframe,text="Stop",command=self.stopsong,width=10,height=1,font=("Helvetica",12,"bold"),fg="white",bg="#1f7a8c").grid(row=0,column=2,padx=10,pad
y=5)
...
playbtn = Button(buttonframe,text="PitchDown",command=self.pitchshiftdown,width=10,height=1,font=("Helvetica",12,"bold"),fg="white",bg="#1f7a8c").grid(row=1,column=2,padx=10,pady=5)
...
playbtn = Button(buttonframe,text="RecordAudio",command=self.recordaudio,width=10,height=1,font=("Helvetica",12,"bold"),fg="white",bg="#a31621").grid(row=2,column=0,padx=10,pady=5)
...
other more commom frequency samples
fs = 44100
#duration of record
second = 15
